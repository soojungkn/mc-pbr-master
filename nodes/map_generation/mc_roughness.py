...
class MC_RoughnessGen:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                "image": ("IMAGE",),
                # Roughness는 보통 Green 채널이나 Luminance가 디테일이 좋습니다.
                "channel": (["Luminance", "Red", "Green", "Blue"], {"default": "Green"}),
    ...
    def generate_roughness(self, image, channel, invert, black_point, white_point, gamma):
        ...
        for img in input_images:
            ...
            # Levels 로직 (유틸 함수로 빼도 되지만, Local-First를 위해 내장)
            epsilon = 1e-5
